...
{
  id: 'ltx_2_5_text_to_video', label: 'Text-to-Video', displayName: 'LTX 2.5', providerFamily: 'Lightricks LTX', version: '2.5', profileSchemaVersion: 1, status: 'runtime_verified', reason: 'Runtime verified at 0.9 MP / 24 FPS / 5 seconds / 121 frames with native Prompt Enhance and synchronized audio: 16:9 final 1280×704, 9:16 final 704×1280, and 1:1 final 960×960.', apiWorkflow: 'workflows/ltx_2_5_text_to_video_api_official.json', requiredNodes: ['CLIPLoader', 'CLIPTextEncode', 'ComfyMathExpression', 'ComfySwitchNode', 'CreateVideo', 'EmptyLTXVLatentVideo', 'KSamplerSelect', 'LatentUpscaleModelLoader', 'LTXVAudioVAEDecode', 'LTXVConcatAVLatent', 'LTXVConditioning', 'LTXVDualCFGGuider', 'LTXVEmptyLatentAudio', 'LTXVLatentUpsampler', 'LTXVSeparateAVLatent', 'ManualSigmas', 'PrimitiveBoolean', 'PrimitiveInt', 'PrimitiveStringMultiline', 'RandomNoise', 'ResolutionSelector', 'SamplerCustomAdvanced', 'SaveVideo', 'TextGenerateLTX2Prompt', 'UNETLoader', 'VAEDecodeTiled', 'VAELoader'],
  modes: [{ id: 'text_to_video', label: 'Text to Video', verified: true, capabilities: { imageToVideo: false, textToVideo: true, continuePrevious: false, multiShot: false, audio: true, referenceImage: false }, aspectRatios: ['16:9 (Widescreen)', '9:16 (Portrait Widescreen)', '1:1 (Square)'], resolutionMegapixels: [0.9], fpsPresets: [24], seed: true, referenceFit: false, audioGuidance: false, nativePromptEnhance: true, postProcessing: ['ltx_native_latent_upscale_x2', 'nvidia_rtx_vsr'] }],
  requiredModels: LTX_2_5_MODEL_MANIFEST,
},
{
  id: 'ltx_2_5_image_to_video', label: 'Image-to-Video', displayName: 'LTX 2.5', providerFamily: 'Lightricks LTX', version: '2.5', profileSchemaVersion: 1, status: 'verified', reason: 'Runtime verified at 0.9 MP / 24 FPS / 5 seconds / 121 frames with native Prompt Enhance and synchronized audio: 16:9 final 1280×704 and 9:16 final 704×1280. Square remains unverified for I2V.', apiWorkflow: 'workflows/ltx_2_5_image_to_video_api.json', requiredNodes: ['CLIPLoader', 'CLIPTextEncode', 'ComfyMathExpression', 'ComfySwitchNode', 'CreateVideo', 'EmptyLTXVLatentVideo', 'KSamplerSelect', 'LatentUpscaleModelLoader', 'LoadImage', 'LTXVAudioVAEDecode', 'LTXVConcatAVLatent', 'LTXVConditioning', 'LTXVDualCFGGuider', 'LTXVEmptyLatentAudio', 'LTXVImgToVideoInplace', 'LTXVLatentUpsampler', 'LTXVPreprocess', 'LTXVSeparateAVLatent', 'ManualSigmas', 'PrimitiveBoolean', 'PrimitiveInt', 'PrimitiveStringMultiline', 'RandomNoise', 'ResizeImageMaskNode', 'ResolutionSelector', 'SamplerCustomAdvanced', 'SaveVideo', 'TextGenerateLTX2Prompt', 'UNETLoader', 'VAEDecodeTiled', 'VAELoader'],
  modes: [{ id: 'image_to_video', label: 'Image to Video', verified: true, capabilities: { imageToVideo: true, textToVideo: false, continuePrevious: false, multiShot: false, audio: true, referenceImage: true }, aspectRatios: ['16:9 (Widescreen)', '9:16 (Portrait Widescreen)'], resolutionMegapixels: [0.9], fpsPresets: [24], seed: true, referenceFit: true, audioGuidance: false, nativePromptEnhance: true, postProcessing: ['ltx_native_latent_upscale_x2', 'nvidia_rtx_vsr'] }],
  requiredModels: LTX_2_5_MODEL_MANIFEST,
}]
