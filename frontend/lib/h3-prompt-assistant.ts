...
export interface H3OllamaStatus { status: 'ready' | 'not_running' | 'model_not_installed' | 'unavailable'; endpoint: string; models: Array<{ name: string; vision_capable: boolean }>; selected_model: string | null; selected_model_available: boolean; vision_capable: boolean; message: string }
