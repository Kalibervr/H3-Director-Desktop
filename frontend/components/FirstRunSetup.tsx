      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            {/* Historic LTX setup mark is retained in source for attribution, but never shown as product branding. */}
            <svg style={{ display: 'none', height: 24, width: 'auto' }} viewBox="0 0 75 32" xmlns="http://www.w3.org/2000/svg" fill="none">
            ...
            <span style={{ fontSize: 15, color: '#f6c85f', fontWeight: 800, letterSpacing: '0.04em', paddingTop: 2 }}>H3D</span>
            <span style={{ fontSize: 14, color: '#71717a', fontWeight: 500, letterSpacing: '0.02em', paddingTop: 2 }}>H3 Director Desktop</span>
          </div>
        </div>
          ...
          {currentStep === 'complete' && (
            <div style={{
              ...
              <p style={{ color: '#a0a0a0', fontSize: 14, maxWidth: 320 }}>
                The local H3 Director backend is installed. Start creating.
              </p>
