...
export function registerAppHandlers(): void {
  ...
  handle('startOllamaRuntime', async () => await startOllamaRuntime())
  handle('stopOllamaRuntime', () => stopOllamaRuntime())
  handle('restartOllamaRuntime', async () => await restartOllamaRuntime())
